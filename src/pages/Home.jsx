...
export default function Home() {
  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      <section className="relative bg-slate-800 text-white py-24 px-4 sm:px-6 lg:px-8 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center space-y-6 z-10">
          <span className="text-amber-500 font-bold uppercase tracking-wider text-sm bg-amber-500/10 px-3 py-1 rounded-full">Do alicerce ao acabamento</span>
          <h1 className="text-4xl sm:text-6xl font-black tracking-tight">
            Tudo para a sua Obra com o <span className="text-amber-500">Melhor Preço</span>
          </h1>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-2xl shadow-md border border-slate-100 flex flex-col items-center text-center space-y-4">
            <div className="bg-amber-100 text-amber-600 p-4 rounded-full"><FaStore size={32} /></div>
      ...
      <section className="bg-white py-16 border-t border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center mb-10 gap-4">
            ...
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold px-5 py-2.5 rounded-xl transition-all flex items-center space-x-2 text-sm">
              <span>Acessar @construfort</span>
            </a>
          </div>
